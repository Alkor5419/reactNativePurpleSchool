...
import PickImage from '../../shared/PickImage/PickImage';
...
export default function Profile() {
	...
	useEffect(() => {
		if (profile && profile.profile?.photo) setImage(profile.profile?.photo);
	}, [profile]);
	...
	return (
		<View>
			<View style={styles.container}>
				<Avatar image={image} />
				<PickImage onUpload={setImage} onError={e => console.log(e)} />
			</View>
